...
void insertion(int val)
{
    ...
    no_of_nodes++;
    cout<<"inserting valuse : "<<val<<endl;
}
...
int main()
{
	...
	ofstream myfile ("v_fib_Heap.txt");
    if (myfile.is_open())
    {
    ...
    //     {
    //         int x , y ;
    //         cout << "Enter value to be decrease : " ;
    //         cin >> x ; 
